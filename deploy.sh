...
# AutoAssistGroup Support System - AWS EC2 Deployment Script
# This script automates the deployment process on Ubuntu/Debian EC2 instances
...
install_python() {
    ...
    apt install -y python${PYTHON_VERSION} python${PYTHON_VERSION}-dev python${PYTHON_VERSION}-venv \
                   python3-pip build-essential libssl-dev libffi-dev libxml2-dev libxslt1-dev \
...
main() {
    log "Starting AutoAssistGroup Support System deployment..."
